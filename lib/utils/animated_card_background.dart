...
class Animations extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          _animatedFigure(10000, endScreen, Alignment.topLeft, true, Color.fromRGBO(0, 163, 0, 1)),
          _animatedFigure(8000, endScreen, Alignment.topCenter, true, Color.fromRGBO(0, 163, 0, 1)),
          _animatedFigure(4000, endScreen, Alignment.topRight, true, Color.fromRGBO(0, 163, 0, 1)),
          _animatedFigure(6000, endScreen, Alignment.topLeft, false, Color.fromRGBO(0, 89, 236, 1)),
          _animatedFigure(7000, endScreen, Alignment.topCenter, false, Color.fromRGBO(0, 89, 236, 1)),
          _animatedFigure(9000, endScreen, Alignment.topRight, false, Color.fromRGBO(0, 89, 236, 1)),
...
Widget _animatedFigure(int duration, double endScreen, Alignment alignment, bool circle, Color color){
  return Align(
              alignment: alignment,
              child: _CuadradoAnimations(
                ...
                endScreen,
                widget: FlareActor(
                  circle ? "assets/animations/circle_animated.flr" : "assets/animations/cross_animated.flr",
